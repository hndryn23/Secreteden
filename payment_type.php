...
try {
    ...
    // Format the date to dd.mm.yy for display purposes
    ...
    $stmt->execute([
        ':date' => $date, // Use the actual date in YYYY-MM-DD format
        ':amount' => $amount,
        ':category' => $category,
    ...
    echo "<script>
        alert('Your payment was successful. Redirecting...');
        window.location.href = 'showsub.html';
    </script>";
